...
# source(paste0(thisdir,"/p_steps/02_T2_30_create_D3_incidence_con_caratterizzazione.R"))
# source(paste0(thisdir,"/p_steps/03_T3_10_Create_D4_pop_ASL.R"))
# source(paste0(thisdir,"/p_steps/03_T3_20_Create_D4_prevalence_incidence.R"))
...
# source(paste0(thisdir,"/p_steps/05_T4_30_cohort_characteristics_subpopulation.R"))
source(paste0(thisdir,"/p_steps/05_T4_30_cohort_characteristics_subpopulation_overall.R"))
source(paste0(thisdir,"/p_steps/05_T4_60_incidence_prevalence.R"))
# source(paste0(thisdir,"/p_steps/06_T5_10_Create_D6_Table_S1.R"))
source(paste0(thisdir,"/p_steps/06_T5_30_Create_D6_Table_1_overall.R"))
# source(paste0(thisdir,"/p_steps/06_T5_20_Create_D6_Table_1.R"))

# source(paste0(thisdir,"/p_steps/06_T5_30_Create_D6_Table_2.R"))
source(paste0(thisdir,"/p_steps/06_T5_60_Create_D6_Figure_1.R"))